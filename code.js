...
function buyItem(element) {
  ...
  if (markFortune - Number(element.dataset.price) >= 0) {
    markFortune -= Number(element.dataset.price);
    totalPercentage = (markFortune * 100) / 128000000000;
...
function updateReceipt() {
  ...
  let receipt = '';
  let total = formatMoney(217000000000 - markFortune);
...
function preLoad() {
  ...
  createAndSaveElement(
    'Toyota Supra',
    230000,
    'https://i.imgur.com/pYGIfzX.jpeg'
  );
  createAndSaveElement(
    'Nissan r34 Nismo',
    210740,
    'https://i.imgur.com/ipl90OL.jpeg'
  );
  createAndSaveElement(
  'Ferrari F8', 
  276000, 
  'https://i.imgur.com/WzJBQ28.jpg'
  );
  createAndSaveElement(
  ...
  createAndSaveElement(
    'Skyscraper',
    850000000,
    'https://i.imgur.com/xSCuNfv.jpeg'
  );
